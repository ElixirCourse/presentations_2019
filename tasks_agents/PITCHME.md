...
* Той е последователно, а данните в него са непроменими. |
...
- Вторият аргумент е период, който даваме на задачата да завърши, след това задачата бива "загасена". |
- Вторият аргумент може да е и атома :brutal_kill, това означава убит задачата моментално по специален начин. |
