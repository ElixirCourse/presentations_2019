...
* Най-лесният начин да изпълним нещо конкуентно на текущата ни код е с абстракция дадена ни в модула Task.
...
* Може да я използваме на готово, като я създаваме с една от функциите: |
  * Task.async/1 - вариант с анонимна функция
  * Task.async/3 - вариант с MFA
* Можем да получим резултата от изпълнената задача с функцията Task.await/1 |
