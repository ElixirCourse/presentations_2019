...
* Използваме ref за да идентифицираме точно върнатото от задачата съобщение, ако сме получили поеве от едно такова. |

---

#### Нека вече да разгледаме структурата Task
