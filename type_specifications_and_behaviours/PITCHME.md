...
другите опции. Дистрибутирания erlang прави това още по-трудно.
...
съобщения, на които функцията "може да приеме". Това бързо става
трудно да си правим на ум `type-checking`
